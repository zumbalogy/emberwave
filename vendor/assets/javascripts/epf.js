(function (global) {
    ...
    require.define('/lib/model/relationships/belongs_to.js', function (module, exports, __dirname, __filename) {
        ...
        BelongsToDescriptor.prototype = new Ember.ComputedProperty(function(){});
    ...
    require.define('/lib/rest/rest_adapter.js', function (module, exports, __dirname, __filename) {
        ...
        Ep.RestAdapter = Ep.Adapter.extend(Ep.EmbeddedHelpersMixin, {
            ...
            refresh: function (model) {
                ...
                var root = this.rootForType(type), adapter = this;
                var id = get(model, 'id');
                return this.ajax(this.buildURL(model, id), 'GET').then(function (json) {
            ...
            update: function (model) {
                ...
                return this.ajax(this.buildURL(model, id), 'PUT', { data: data }).then(function (json) {
                    return Ember.run(adapter, 'didReceiveData', json, model);
                }, function (xhr) {
                    throw Ember.run(adapter, 'didError', xhr, model);
                });
            ...
            create: function (model) {
                ...
                return this.ajax(this.buildURL(model), 'POST', { data: data }).then(function (json) {
                    json[root].client_id = data[root].client_id;
                    return Ember.run(adapter, 'didReceiveData', json, model);
                }, function (xhr) {
                    throw Ember.run(adapter, 'didError', xhr, model);
                });
            ...
            deleteModel: function (model) {
                ...
                root = this.rootForType(type);
                adapter = this;
                return this.ajax(this.buildURL(model, id), 'DELETE').then(function (json) {
                    delete json.deleted;
                    return Ember.run(adapter, 'didReceiveData', json, model);
                }, function (xhr) {
                    throw Ember.run(adapter, 'didError', xhr, model);
            ...
            buildURL: function (model, suffix) {
                ...
                var url = [this.url];
                if (model_url) {
                    var id = model.get(model_url) && model.get(model_url).get('id') || model.get(model_url + '_id');
                    url.push(this.pluralize(model_url));
                    url.push(id);
                }
                Ember.assert('Namespace URL (' + this.namespace + ') must not start with slash', !this.namespace || this.namespace.toString().charAt(0) !== '/');
                Ember.assert('Record URL (' + root + ') must not start with slash', !root || root.toString().charAt(0) !== '/');
    ...
    require.define('/lib/transforms/index.js', function (module, exports, __dirname, __filename) {
        ...
        require('/lib/transforms/raw.js', module);
    });
    require.define('/lib/transforms/raw.js', function (module, exports, __dirname, __filename) {
        Ep.RawTransform = Ep.Transform.extend({
    ...
    require.define('/lib/session/session.js', function (module, exports, __dirname, __filename) {
        ...
        Ep.Session = Ember.Object.extend({
            ...
            undirtyModel: function (model) {
                this.shadows.remove(model);
                model.propertyDidChange('isDirty');
            },
            deleteModel: function (model) {
                if (get(model, 'isNew')) {
